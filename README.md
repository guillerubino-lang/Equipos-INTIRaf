...
- **Foto de portada** → en la galería, tocar la estrellita ★ de una foto la marca como la que representa a ese equipo en el informe PDF (y a futuro, en cualquier otra vista que muestre "una" foto por equipo). Tocarla de nuevo la desmarca. Si no marcás ninguna, se usa la primera foto subida. Funciona igual en la galería de un equipo que en la de un hallazgo de Altas pendientes.
- **Recordatorio de verificación** → los botones ✓ Encontrado / ✕ No encontrado quedan fijos arriba mientras scrolleás el resto de la ficha, y si cerrás sin haberlos tocado (equipo sigue en "Pendiente"), la app te lo pregunta antes de dejarte salir — para no olvidarte de marcarlo en medio de un recorrido.
...
- **Miniatura circular de la foto** → cada tarjeta muestra a la izquierda una foto chica (la de portada si hay una marcada, si no la primera subida) — mismo estilo que una foto de perfil. Se carga sola solo para las tarjetas que están en pantalla (o por entrar), a medida que scrolleás, así no se descargan las 700 de una. Usa la miniatura liviana que genera Google Drive (unos KB), no la foto completa — para que no se sienta lento ni pese de más en el celular. Si el equipo no tiene fotos, el círculo queda gris con "sin foto". **Tocar la miniatura abre la foto ampliada** (mismo visor de siempre, con el link a Drive); tocar cualquier otra parte de la tarjeta abre la ficha completa, como siempre.
...
- Hay **un solo informe en PDF**, que mezcla equipos y altas pendientes exactamente igual que la lista filtrada en pantalla — nunca deja afuera lo que ves ahí. Las altas se distinguen con un ícono 📋 y un borde violeta en su ficha, y el pie de página aclara cuántas de las incluidas son altas pendientes.
